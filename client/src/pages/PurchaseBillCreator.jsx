                  ...
                  <div key={index} className="bg-slate-50 border border-slate-200 rounded-xl p-3 space-y-2">
                    ...
                    {useProduct ? (
                              ...
                              return filtered.length > 0 ? filtered.map(p => {
                                ...
                                return (
                                  <button key={p.id} type="button" onMouseDown={() => {
                                    ...
                                    setItems(updated); setFocusedRowIndex(null);
                      ...
                      <input type="text" value={item.name}
                        ...
                        required placeholder={t.inventoryItemDetails || 'Item / Service'}
                        className="w-full bg-white border border-slate-200 rounded-lg px-2.5 py-2 text-xs font-semibold focus:outline-none"
                      />
                    )}
                    <div className="grid grid-cols-3 gap-2">
                      ...
                      <div>
                        ...
                        <div className="bg-emerald-50 border border-emerald-100 rounded-lg px-2 py-1.5 text-xs text-right font-mono font-black text-slate-800">
                          ₹{lineTot.toFixed(2)}
                        </div>
                      </div>
                    </div>
